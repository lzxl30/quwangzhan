var turingTools = [
  ...
  },
  {
    id: 'turing-4',
    title: '图片隐写',
    url: 'tools/turing/pages/hidefile.html',   // ← 新增 pages/
  ...
  },
  {
    id: 'turing-5',
    title: 'ASCII 字符画',
    url: 'tools/turing/pages/ascii.html',      // ← 新增 pages/
  ...
  },
  {
    ...
    description: '在线图片盲盒工具，将两张图片无缝融合，创造独特的叠加混合效果。',
    category: 'turing',
    icon: '🎁',
    iconBgClass: 'bg-5',
  ...
  },
  {
    id: 'turing-7',
    title: '二维码生成',
    url: 'tools/turing/pages/qrcode.html',     // ← 新增 pages/
  ...
  },
  {
    ...
    title: '对称光绘',
    url: 'https://silk.art/',
    description: '<a href="http://weavesilk.com/" target="_blank" rel="noopener" style="color:#8b7cf7;text-decoration:underline;">电脑端在这</a> ，在线丝绸绘画工具，用鼠标或手指画出飘逸灵动的丝绸线条，极具艺术感。',
    category: 'turing',
    icon: '🎨',
    iconBgClass: 'bg-3',
    accentClass: 'accent-3',             // 建议在新窗口打开，避免 iframe 被第三方限制
  },
  {
